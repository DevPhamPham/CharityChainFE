 ...
 */ !function(a, b, c, d) {
    ...
    e.Defaults = {
        ...
        a.each([
            b
        ].concat(this._states.tags[b] || []), a.proxy(function(a, b) {
    ...
    e.Defaults = {
        ...
        ]), this._controls.$absolute = (c.dotsContainer ? a(c.dotsContainer) : a("<div>").addClass(c.dotsClass).appendTo(this.$element)).addClass("disabled"), this._controls.$absolute.on("click", "div", a.proxy(function(b) {
...
//# sourceMappingURL=index.9a569401.js.map
